...
def list_movies():
    ...
    movies.append(media.Movie(
        ...
        "https://vignette1.wikia.nocookie.net/greatest-movies/images/3/3f/"
        "Monty_pythons_life_of_brian.jpg/revision/latest?cb=20170820100523",
    ...
    movies.append(media.Movie(
        ...
        "monty-python-and-the-holy-grail-movie-poster-1975-1010465239.jpg",
    ...
    movies.append(media.Movie(
        ...
        "http://img.moviepostershop.com/"
        "annie-hall-movie-poster-1977-1010725380.jpg",
